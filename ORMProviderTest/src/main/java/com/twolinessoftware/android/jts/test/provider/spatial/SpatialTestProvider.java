...
public class SpatialTestProvider extends MappedContentProvider<SpatialTestModel>{

	public static final String PROVIDER_NAME = "com.twolinessoftware.spatialtestprovider";
