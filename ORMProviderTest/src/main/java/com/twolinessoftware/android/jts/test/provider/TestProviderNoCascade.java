...
public class TestProviderNoCascade extends MappedContentProvider<TestModelNoCascade>{

	public static final String PROVIDER_NAME = "com.twolinessoftware.testprovidernocascade";
